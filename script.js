(function($) {
  ...
  $(function() {
    var someCallback = function(exifObject) {
      ...
      // data is inserting into html element by id  
      $('#cameraModel').val(exifObject.Model);
      $('#aperture').val('f/'+exifObject.FNumber);
      $('#xresolution').val(exifObject.XResolution);
      $('#yresolution').val(exifObject.YResolution);
      $('#DateTime').val(exifObject.DateTime);
      $('#Software').val(exifObject.Software);
      $('#ShutterSpeed').val(exifObject.ShutterSpeedValue);
      $('#Brightness').val(exifObject.BrightnessValue);
      $('#exposureTime').val(exifObject.ExposureTime + ' seg.');

      $('#GPSLatitude').val(exifObject.GPSLatitude);
      $('#GPSLongitude').val(exifObject.GPSLongitude);
      $('#GPSAltitude').val(exifObject.GPSAltitude);
      $('#GPSSpeedRef').val(exifObject.GPSSpeedRef);
      $('#GPSImgDirection').val(exifObject.GPSImgDirection);
      $('#XPComment').val(exifObject.UserComment);
